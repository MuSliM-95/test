...
import { EditPayment } from "src/features/Modal"
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc';
import _ from "lodash";
import axios from 'axios';
import { CreatePayment } from 'src/features/Modal'
import { SplitPayment } from 'src/features/Modal';
import { RaspilView } from 'src/features/Modal';
import DebounceSelectFil from "src/features/DebFetchFilters"
						...
						<>
							...
							{(record.raspilen || record.parent_id) ?
								<RaspilView token={this.props.query.token} payment={record} projects_select={this.props.PRData}
									caData={this.props.caSel} /> :
								<SplitPayment token={this.props.query.token} payment={record} projects_select={this.props.PRData}
									caData={this.props.caSel} />}
						</>
