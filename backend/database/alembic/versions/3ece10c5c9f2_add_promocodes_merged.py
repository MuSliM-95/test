...
def upgrade() -> None:
    op.create_table('promocodes',
        ...
        sa.Column('type', sa.Enum('ONE_TIME', 'PERMANENT', name='promocodetype'), nullable=False),
        ...
        sa.ForeignKeyConstraint(['creator_id'], ['tg_accounts.id'], ),
        sa.ForeignKeyConstraint(['distributor_id'], ['contragents.id'], ),
