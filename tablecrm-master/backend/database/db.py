...
mp_orders = sqlalchemy.Table(
    ...
    metadata,
    sqlalchemy.Column("id", Integer, primary_key=True, index=True),
    sqlalchemy.Column("order_id", String, unique=True, nullable=False),
    sqlalchemy.Column("product_id", Integer, nullable=False),
    sqlalchemy.Column("listing_pos", Integer),
    sqlalchemy.Column("listing_page", Integer),
    sqlalchemy.Column("location_id", Integer),
    ...
    sqlalchemy.Column("status", String, nullable=False, server_default="pending"),
    sqlalchemy.Column("routing_meta", JSON),
    sqlalchemy.Column("created_at", DateTime(timezone=True), server_default=func.now()),
    sqlalchemy.Column("updated_at", DateTime(timezone=True), server_default=func.now(), onupdate=func.now()),
)
